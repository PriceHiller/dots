...
" Levels
"---------------------------------------------------------------------------
syn keyword logLevelEmergency EMERGENCY EMERG emergency emerg
syn keyword logLevelAlert ALERT alert
syn keyword logLevelCritical CRITICAL CRIT FATAL critical crit fatal
syn keyword logLevelError ERROR ERR FAILURE SEVERE Error error err
syn keyword logLevelWarning WARNING WARN Warning warning warn
syn keyword logLevelNotice NOTICE
syn keyword logLevelInfo INFO info
syn keyword logLevelDebug DEBUG FINE debug
syn keyword logLevelTrace TRACE FINER FINEST trace
...
hi def link logBrackets @punctuation.bracket
