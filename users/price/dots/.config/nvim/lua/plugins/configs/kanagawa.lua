...
return {
    {
        ...
        config = function()
            ...
            local extra_hls = {
                ...
                { "CursorLineNr", { fg = colors.roninYellow, bg = colors.sumiInk1 } },
                { "CursorLineFold", { fg = colors.crystalBlue, bg = colors.sumiInk1 } },
                { "CursorLineSign", { bg = colors.sumiInk1 } },
                { "CursorLineSep", { fg = get_hl("NonText")().fg, bg = colors.sumiInk1 } },
                ...
                { "BlinkCmpKindFile", { fg = colors.fujiWhite, bg = colors.waveBlue1, blend = 0 } },
                { "BlinkCmpKindUnit", { fg = colors.fujiWhite, bg = colors.autumnYellow, blend = 0 } },
                { "BlinkCmpKindSnippet", { fg = colors.sumiInk3, bg = colors.carpYellow, blend = 0 } },
                { "BlinkCmpKindFolder", { fg = colors.fujiWhite, bg = colors.waveBlue2, blend = 0 } },
